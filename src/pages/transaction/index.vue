<template>
    ...
    <nut-row>
        <nut-col :span="12">
            <nut-button type="success" class="btn" @click="fetchTransaction" block>查询</nut-button>
        </nut-col>
        <nut-col :span="12">
            <nut-button type="success" class="btn" @click="goToPage('/pages/transaction/add')" block>添加</nut-button>
        </nut-col>
...
const fetchTransaction = () => {
    Taro.request({
        url: 'http://101.200.32.224:3000/financial/transaction/list',
        method: 'POST',
        data: {
...
async function Updateconfirm() {
    await Taro.request({
        url: 'http://101.200.32.224:3000/financial/transaction/update',
        method: 'POST',
        data: {
...
async function handleDelete(Id) {
    console.log(Id);
     await Taro.request({
        url: 'http://101.200.32.224:3000/financial/transaction/delete',
        method: 'POST',
        data: {
            transactionId: Id,
        }
